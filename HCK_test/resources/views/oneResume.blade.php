...
<div class="alert alert-info">
  ...
  <a href="{{ route('downloadPDF', $resume) }}"><button class="btn btn-danger">Download Resume</button></a>
  <br>
  <a href="{{ route('updateResume', $resume) }}"><button class="btn btn-danger">Update</button></a>
